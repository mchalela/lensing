...
print 'Ndim 2'
densmodel.mcmc.mcmc_create_samples(args=args_fix_off, ndim=2, nwalkers=10, steps=300, file_name=name, threads=24)
samples_file = 'samples_dim.10.300.2.'+name+'.txt'
print 'Ndim 3'
densmodel.mcmc.mcmc_create_samples(args=args_fix_none, ndim=3, nwalkers=10, steps=300, file_name=name, threads=24)
